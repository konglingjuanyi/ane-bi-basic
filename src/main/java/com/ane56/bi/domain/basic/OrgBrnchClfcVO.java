...
public class OrgBrnchClfcVO {
	...
	private String siteName;//分拨名称
	private String clfcTypeCdStr;//分拨类型字符串
	private String clfcDtldCdStr;//分拨功能字符串
	private String statFlagStr;//是否统计字符串
	...
	public String getClfcTypeCdStr() {
		return clfcTypeCdStr;
	}
	public void setClfcTypeCdStr(String clfcTypeCdStr) {
		this.clfcTypeCdStr = clfcTypeCdStr;
	}
	public String getClfcDtldCdStr() {
		return clfcDtldCdStr;
	}
	public void setClfcDtldCdStr(String clfcDtldCdStr) {
		this.clfcDtldCdStr = clfcDtldCdStr;
	}
	public String getStatFlagStr() {
		return statFlagStr;
	}
	public void setStatFlagStr(String statFlagStr) {
		this.statFlagStr = statFlagStr;
	}
